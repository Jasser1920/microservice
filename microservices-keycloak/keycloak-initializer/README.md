...
- **KEYCLOAK_PORT**: Port number for Keycloak (Example: 8080)
...
- **FRONTEND_CLIENT_ID**: Client ID for the frontend SPA client (Example: frontend-client)
- **FRONTEND_URL**: Frontend base URL for redirect URIs (Example: http://localhost:8091)
...
1. Start Keycloak:
  ...
  Ensure that Keycloak is running and accessible on the correct port (Example: 8080).
